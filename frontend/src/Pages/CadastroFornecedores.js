...
import Grafico from "../Pages/GraficoCadastroFornecedores.js";
          ...
          <div className="head-title">
            <div className="left">
              ...
              <ul className="breadcrumb">
                ...
                <li>
                  <a className="active" href="#">Cadastro de Fornecedores</a>
                </li>
              </ul>
            </div>
          ...
          <div className="table-data">
            ...
            <div className="todo">
              ...
              <ul className="todo-list">
                ...
                <li className="completed">
                  <p>Negociação de Termos</p>
                  <LuMoreVertical />
                </li>
                <li className="completed">
                  <p>Feedback e Melhoria</p>
                  <LuMoreVertical />
                </li>
              </ul>
            </div>
